...
To maximize sum spectral efficiency under total transmit power constraint $P_{total}$:
...
2. **Correlation Resilience:** When spatial correlation $\rho = 0.9$, Water-Filling provides up to **$48.5\%$ capacity gains** over unoptimized equal-power transmission.
